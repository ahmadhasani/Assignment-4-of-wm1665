            ...
            <div class="container top-sidebar">
                <div class="row">
                    <div class="col-xs-12 col-sm-3">
                        <div class="searching-box single-sidebar">
                            <form method="get">
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <div class="single-sidebar sidebar-select"> <span>Color : </span>
                            <select name="name">
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <div class="single-sidebar sidebar-select"> <span>Sort By : </span>
                            <select name="name">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-3">
                        <div class="single-sidebar sidebar-select"> <span>Category : </span>
                            <select name="name">
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <div class="single-sidebar sidebar-select"> <span>Subcategory : </span>
                            <select name="name">
                                <option value="">Sweetshirt</option>
                                <option value="">Latest</option>
                                <option value="">Boy</option>
                                <option value="">Kids</option>
                                <option value="">Women</option>
                    ...
                    <div class="col-xs-12 col-sm-3">
                        <div class="single-sidebar sidebar-select">
                            <div class="grid-list-button alignright">
